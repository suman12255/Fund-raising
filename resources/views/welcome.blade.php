          ...
          <div class="row h-100">
            <div class="col-12 col-lg-8 d-flex flex-column justify-content-center align-items-start">
              ...
              <div class="entry-content mt-4">
                <p>A Platform For Financially Unstable And Under Privileged people To Get Financial Support.</p>
              </div><!-- .entry-content -->
        ...
        <div class="container h-100">
          <div class="row h-100">
            <div class="col-12 col-lg-8 d-flex flex-column justify-content-center align-items-start">
              ...
              <div class="entry-content mt-4">
                <p>A Platform For Financially Unstable And Under Privileged peopleTo Get Financial Support.</p>
              </div><!-- .entry-content -->
    ...
    <div class="row">
      ...
      <div class="col-12 col-md-6 col-lg-4 mt-4 mt-lg-0">
        <div class="icon-box">
          ...
          <div class="entry-content">
            <p>Donate money to underprivileged peopleand they will be future donor. Lets pay it forward to one  to another. Together we will bring a world where there will be no word of "underprivileged".  “My happiness comes from the donation of my life in many ways for the current and for the future generations.”
              ― Debasish Mridha. </p>
          </div>
        </div>
      </div>
      ...
      <div class="col-12 col-md-6 col-lg-4 mt-4 mt-lg-0">
        <div class="icon-box">
          ...
          <div class="entry-content">
            <p>Society will do better when you start donating. Your contribution is indispensable for society's progress. Richness is not necessary foe donation, willingness is. A little contribution can't change the world but it can change someone's world. </p>
          </div>
        </div>
      </div>
    </div><!-- .row -->
    ...
    <div class="row">
      <div class="col-12 col-lg-6 order-2 order-lg-1">
        <div class="welcome-content">
          <header class="entry-header">
            <h2 class="entry-title">Welcome to We Fund </h2>
          </header><!-- .entry-header -->
...
<div class="home-page-limestone">
  <div class="container">
    <div class="row align-items-end">
      <div class="coL-12 col-lg-6">
        <div class="section-heading">
          <h2 class="entry-title"> The key to change is to concentrate the majority of your vitality not on battling the old, but rather on building the new.</h2>
